...
class BeaconTableViewCell: UITableViewCell {
    ...
    internal func configureCell(for beacon: Beacon) {
        self.rssi.text = "RSSI " + "\(beacon.filteredRSSI) dBM"
        ...
        guard let instance = beacon.beaconID.instance, let namespace = beacon.beaconID.namespace else {
            ...
            self.beaconMac.text = "MAC: " + beacon.beaconID.description
        ...
        self.beaconNamespace.text = "MAC: " + "Namespace: \(namespace.hexString)"
        self.beaconInstance.text = "Battery \(batteryAmount)% " + "Instance: \(instance.hexString)"
